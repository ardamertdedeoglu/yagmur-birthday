/**
 * Story data - Add as many story parts as you want!
 * The background colors will automatically cycle through the 3 defined colors.
 *
 * Each story object has:
 * - id: unique identifier
 * - text: the story content (3-4 sentences)
 */
